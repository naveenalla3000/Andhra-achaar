-- Add contact_number to stores
ALTER TABLE public.stores
  ADD COLUMN IF NOT EXISTS contact_number text;

-- Snapshot contact_number on orders
ALTER TABLE public.orders
  ADD COLUMN IF NOT EXISTS store_contact_number text;

-- Replace checkout() to snapshot store_contact_number
...
begin
  ...
  loop
    insert into public.orders (
      ...
      checkout_id,
      order_ref,
      store_id, store_name, store_address, store_image_url,
    ...
    select
      ...
      v_checkout_id,
      v_order_ref,
      v_store, s.name, s.address, s.image_url,
    ...
    group by s.name, s.address, s.image_url, s.latitude, s.longitude, s.contact_number

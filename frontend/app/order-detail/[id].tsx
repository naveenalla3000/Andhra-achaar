...
const styles = StyleSheet.create({
  ...
  pickupHeader: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  pickupLabel: { fontFamily: fonts.textBold, fontSize: 10, color: colors.brandPrimary, letterSpacing: 1 },
  pickupDivider: { width: '100%', height: 1, backgroundColor: colors.brandPrimary + '25', marginVertical: 2 },
  pickupCode: { fontFamily: fonts.display, fontSize: 22, color: colors.brandPrimary, letterSpacing: 8 },
  pickupHint: { fontFamily: fonts.text, fontSize: 10, color: colors.muted },
